...
# remove previous port configurations.
rm -r driver*
rm -r worker*

# d = number of expected driver nodes
# w = number of expected worker nodes
d=$1
w=$2
master=$3

etcdctl set /etcd_service/drivers $d
etcdctl set /etcd_service/workers $w
